# 高性价比国内外VPS/云服务器推荐【附优惠码】 2026/2/8更新
**本文不定期更新，敬请收藏。（本次更新时间：2026年2月8日00时13分）**
## 前言
...
**下面表格中我仅列出<span style="color:red">原价</span>，实际购买时，首月五折，季付九折，半年付八折，年付七折。**
...
**注：**
* **以上不包含游戏云，我在这里简单说一下。以我的世界为例，5+人服（2核4G 50M 10G）¥30/月，10+人服（4核8G 50M 10G）¥75/月，15+人服（6核12G 50M 10G）¥130/月。**
* **上表所标价格全部为折扣前。**
* **所有VPS支持七天无理由退订。**
* **月流量次月不清零，自动累加，流量用完后限至5M，额外流量按300G/15元，1024G/35元。**

雨云出了一些新的好玩的东西，比如云应用商店、CDN和对象存储等。
最强的还是游戏云，雨云针对性地开发了各类面板，如果你想部署我的世界，饥荒，幻兽帕鲁等主流游戏，那么在网页上就可以一键搞定。

### 二、[智星云（GPU算力服务器）](https://gpu.ai-galaxy.cn/login?page=register&salesCode=7D8CD5)
官网地址：[https://gpu.ai-galaxy.cn](https://gpu.ai-galaxy.cn/login?page=register&salesCode=7D8CD5 "https://gpu.ai-galaxy.cn/")

优惠码：`7D8CD5`

**主要提供的是GPU算力服务器，租用时长的最低单位是小时，如果你有自部署AI大模型或流体力学、化学、分子物理学、深度学习算法、有限元分析等计算需求可以考虑这家，如果是网站、游戏、服务部署则跳过。**

智星云GPU算力服务平台，是国内知名专业算力服务品牌，专注提供弹性 GPU云加速服务。平台管理和调度超过2000台GPU服务器，涵盖英伟达全系列产品及多款国产信创GPU服务器。 历经 6 年深耕，已构建以GPU弹性算力服务、裸金属服务、GPU硬件供应、GPU算力调用系统部署为核心的多业务生态体系。产品广泛服务于高校、科研机构、互联网、金融、政企等领域，覆盖高性能计算、人工智能、创意渲染、云游戏等多元应用场景，已为全国近万家企业及高校客户提供专业服务。

以下列出部分配置，价格由低到高，注意单位为小时：
| CPU | GPU | 内存 | 显存 | 带宽 | 月流量 | 硬盘 | 价格/小时 |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
| 48核 | 无 | 48G | 无  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥0.78 |
| 8核 | NVIDIA A800-SXM4 | 16G | 40G  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥1.9 |
| 8核 | NVIDIA A100-SXM4 | 16G | 40G  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥2.19 |
| 8核 | NVIDIA A100-SXM4 | 16G | 80G  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥4.9 |
| 8核 | GeForce RTX 4090 | 16G | 24G  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥1.32 |
| 8核 | Tesla V100 | 16G | 32G  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥1.0 |
| 8核 | RTX A6000 | 16G | 48G  | 共享32Mbps（往后0.003元/兆/小时） | 无限 | 500G | ￥2.19 |

**注：**
* **日付98折，年付95折。**
* **以上列出的服务都是单张GPU，GPU最多可扩展为8张。**

### 三、[浪浪云](https://langlangy.cn/?i475b52)
